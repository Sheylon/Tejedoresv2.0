    ...
    <header>
        <div class="seccion">
            <ul>
                <li>
                    <ul class="menu">
                        <li>
                            ...
                            <ul class="submenu2">
                                <li>
                                    <a clas="enlace_seccion" href="funciones/carrito/index.html">
                                        <i class="fa-solid fa-cart-shopping"></i>
                                        Compras</a>
                                </li>
                                <li>
                                    <a clas="enlace_seccion" href="funciones/Vender/index.html">
                ...
                <li>
                    <a clas="enlace_seccion" href="RegistroLogin.php">Inicio | Registro </a>
                </li>
            </ul>
        </div>
